 ...
 * 谐波电压实时表
 */
public class TOnlineDataHarmonicU implements IShardable<Integer>,IBatchAble
{
    //编号
    ...
    public BigDecimal getBaseU() {
        return baseU;
    }

    public void setBaseU(BigDecimal baseU) {
        this.baseU = baseU;
    }

    private static final String tableName = "t_online_data_harmonic_u";
